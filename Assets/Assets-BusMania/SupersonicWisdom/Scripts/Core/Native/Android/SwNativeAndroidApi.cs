...
namespace SupersonicWisdomSDK
{
    internal class SwNativeAndroidApi : SwNativeApi
    {
        ...
        {
            return NativeBridge.ReleaseSessionBackgroundTime();
        }

        public override DateTime CaptureSessionBackgroundTime()
        {
            return NativeBridge.CaptureSessionBackgroundTime();
        }
        ...
        {
            return NativeBridge.GetScreenWidth();
        }

        public override float GetScreenHeight()
        {
            return NativeBridge.GetScreenHeight();
        }

        public override float GetScreenScaleFactor()
        {
            return NativeBridge.GetScreenScaleFactor();
        }
