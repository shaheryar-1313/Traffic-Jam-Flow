...
namespace SupersonicWisdomSDK
{
    internal class SwNativeIosBridge : SwNativeBridge
    {
        ...
        {
#if UNITY_IOS
            initializeSession(SwUtils.JsonHandler.SerializeObject(metadata));
#endif
        }
        ...
        {
#if UNITY_IOS
            setEventMetadata(SwUtils.JsonHandler.SerializeObject(metadata));
#endif
        }
        ...
        {
#if UNITY_IOS
            updateEventMetadata(SwUtils.JsonHandler.SerializeObject(metadata));
#endif
        }
        ...
        [DllImport("__Internal")]
        private static extern float getScreenWidth();
