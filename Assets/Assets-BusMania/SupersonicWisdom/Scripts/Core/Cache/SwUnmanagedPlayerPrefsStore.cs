...
namespace SupersonicWisdomSDK
{
    ...
    {      
        ...
        {
            return PlayerPrefs.GetInt(key, defaultValue.SwToInt()) != 0;
        }
        ...
        {
            var jsonString = PlayerPrefs.GetString(key, SwUtils.JsonHandler.SerializeObject(defaultValue));
            return SwUtils.JsonHandler.DeserializeObject<T>(jsonString);
        }
        ...
        {
            PlayerPrefs.SetInt(key, value.SwToInt());
            if (save) Save();
            return this;
        }
        ...
        {
            var jsonString = SwUtils.JsonHandler.SerializeObject(value);
