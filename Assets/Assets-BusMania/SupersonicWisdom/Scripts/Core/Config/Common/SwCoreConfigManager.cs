...
namespace SupersonicWisdomSDK
{
    internal abstract class SwCoreConfigManager : ISwConfigManager, ISwNativeRequestListener, ISwLocalConfigProvider, ISwReadyEventListener, ISwGameStateSystemListener
    {
        ...
        private const string SERVER_RESPONSE_TRIGGER_KEY = "server_response";
        ...
        {
            var settingsValues = _settings.GetValues();
            
            SwInfra.Logger.Log(EWisdomLogType.Config, $"Loading settings with {settingsValues.Count} keys");
            
            Config.DynamicConfig.SwMerge(true, settingsValues);
        }
