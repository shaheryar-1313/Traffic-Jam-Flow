...
namespace SupersonicWisdomSDK
{
    internal static class SwStringExtMethods
    {
        ...
        {
            return SwUtils.JsonHandler.DeserializeObject<Dictionary<string, object>>(self);
        }
        ...
        public static string SelectFirstXCharacters(this string self, int count)
        {
            return self.Length <= count ? self : self[..count];
        }
