...
namespace SupersonicWisdomSDK
{
    ...
    internal class SwStage10FacebookAdapter : ISwAdapter, ISwScriptLifecycleListener, ISwAsyncRunnable
    {
        #region --- Events ---
        ...
        private void InitInternal(bool isAppResume = false)
        {
            ...
            if (!FB.IsInitialized)
            {
                ...
                {
                    SwInfra.Logger.LogException(e, EWisdomLogType.Facebook, $"Failed {nameof(InitInternal)}");
                    _canInit = true;
