    ...
    internal class SwStage10IntegrationManager
    {
        ...
        private Dictionary<string, ESwTestCaseStatus> PreviousRunStatus
        {
            get
            {
                ...
                try
                {
                    previousRunStatusObject = previousRunStatusString != null ? SwUtils.JsonHandler.DeserializeObject<SerializedTestCaseStatus[]>(previousRunStatusString) : null;
                }
                catch (Exception e)
                {
                    SwInfra.Logger.LogException(e, EWisdomLogType.IntegrationTool, "No previous status");
                }
        ...
        {
            return integrationRawData.SwIsNullOrEmpty() ? null : SwUtils.JsonHandler.DeserializeObject<SwIntegrationToolSuiteRawData>(integrationRawData);
        }
        ...
        private void Save()
        {
            ...
            var allJsonString = SwUtils.JsonHandler.SerializeObject(statusDict);
