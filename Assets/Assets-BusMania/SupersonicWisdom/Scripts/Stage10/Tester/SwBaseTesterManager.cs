...
namespace SupersonicWisdomSDK
{
    public class SwBaseTesterManager : MonoBehaviour
    {
        ...
        [SerializeField] private Transform _buttonsScrollView;
        ...
        {
            var x = _buttonsScrollView.position.x;
            var y = _buttonsScrollView.position.y == 0f ? 250f : 0f;
            var z = _buttonsScrollView.position.z;
            _buttonsScrollView.position = new Vector3(x, y, z);
        }
