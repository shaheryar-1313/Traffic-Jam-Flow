...
namespace SupersonicWisdomSDK
{
    ...
    internal class SwStage10AppsFlyerAdapter : ISwReadyEventListener, ISwAppsFlyerListener, ISwLocalConfigProvider, ISwAdapter, ISwStage10ConfigListener, ISwAsyncRunnable
    {
        ...
        private const string APPS_FLYER_INIT_TRIGGER_KEY = "af_init_complete";
        ...
        public SwStage10AppsFlyerAdapter(SwAppsFlyerEventDispatcher eventDispatcher, SwStage10UserData userData, SwSettings settings, SwCoreTracker tracker)
        {
