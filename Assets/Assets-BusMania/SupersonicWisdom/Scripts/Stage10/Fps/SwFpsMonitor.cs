...
namespace SupersonicWisdomSDK
{
    internal class SwStage10FpsMonitor : ISwFpsMonitor
    {
        ...
        private FpsMeasurementSummary CreateSummary()
        {
            ...
            SwInfra.Logger.Log(EWisdomLogType.Fps, $"All FPS measurement summary: {SwUtils.JsonHandler.SerializeObject(fpsMeasurementSummary)}");
