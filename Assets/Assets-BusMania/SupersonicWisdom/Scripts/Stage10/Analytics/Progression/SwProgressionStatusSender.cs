...
namespace SupersonicWisdomSDK
{
    internal sealed class SwProgressionStatusSender : SwBaseAnalyticsManager, ISwGameProgressionListener
    {
        ...
        {
            OnLevelApiCalled(SwProgressEvent.LevelCompleted, levelType, level, customString, attempts, revives);
        }

        public void OnLevelFailed(ESwLevelType levelType, long level, string customString, long attempts, long revives)
        {
            OnLevelApiCalled(SwProgressEvent.LevelFailed, levelType, level, customString, attempts, revives);
        }

        public void OnLevelRevived(ESwLevelType levelType, long level, string customString, long attempts, long revives)
        {
            OnLevelApiCalled(SwProgressEvent.LevelRevived, levelType, level, customString, attempts, revives);
        }

        public void OnLevelSkipped(ESwLevelType levelType, long level, string customString, long attempts, long revives)
        {
            OnLevelApiCalled(SwProgressEvent.LevelSkipped, levelType, level, customString, attempts, revives);
        }

        public void OnLevelStarted(ESwLevelType levelType, long level, string customString, long attempts, long revives)
        {
            OnLevelApiCalled(SwProgressEvent.LevelStarted, levelType, level, customString, attempts, revives);
        }

        public void OnLevelContinued(ESwLevelType levelType, long level, string customString, long attempts, long revives)
        {
            OnLevelApiCalled(SwProgressEvent.LevelContinued, levelType, level, customString, attempts, revives);
        }
